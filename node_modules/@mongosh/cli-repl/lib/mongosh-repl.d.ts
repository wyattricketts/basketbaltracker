...
declare class MongoshNodeRepl implements EvaluationListener {
    ...
    initialize(serviceProvider: ServiceProvider, greeting?: GreetingDetails): Promise<InitializationToken>;
    ...
    greet(mongodVersion: string, greeting?: GreetingDetails): Promise<void>;
