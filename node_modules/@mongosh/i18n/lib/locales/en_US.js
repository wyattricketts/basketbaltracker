...
const translations = {
    ...
    'cli-repl': {
        args: {
            ...
            oidcRedirectUri: 'Local auth code flow redirect URL [http://localhost:27097/redirect]',
            ...
            oidcDumpTokens: "Debug OIDC by printing tokens to mongosh's output [redacted|include-secrets]",
        ...
        classes: {
            ...
            ShellApi: {
                help: {
                    ...
                    attributes: {
                        log: {
                            description: "'log.info(<msg>)': Write a custom info/warn/error/fatal/debug message to the log file\n" +
            ...
            ClientBulkWriteResult: {
                help: {
                    ...
                    attributes: {
                        ...
                        insertResults: {
                            description: 'The results of each individual insert operation that was successfully performed',
                        },
                        updateResults: {
                            description: 'The results of each individual update operation that was successfully performed',
                        },
                        deleteResults: {
                            description: 'The results of each individual delete operation that was successfully performed.',
                        },
                    },
                },
            },
                ...
                help: {
                    ...
                    attributes: {
                        addOption: {
                            ...
                            example: 'db.collection.find(query, projection, options).addOption(flag)',
                        },
                        allowPartialResults: {
                            ...
                            example: 'db.collection.find(query, projection, options).allowPartialResults()',
                        },
                        allowDiskUse: {
                            ...
                            example: 'db.collection.find(query, projection, options).sort(sort).allowDiskUse(false)',
                        },
                        batchSize: {
                            ...
                            example: 'db.collection.find(query, projection, options).batchSize(10)',
                        },
                        close: {
                            link: 'https://docs.mongodb.com/manual/reference/method/cursor.close',
                            description: 'Instructs the server to close a cursor and free associated server resources. The server will automatically close cursors that have no remaining results, as well as cursors that have been idle for a period of time and lack the cursor.noCursorTimeout() option.',
                        ...
                        collation: {
                            ...
                            example: 'db.collection.find(query, projection, options).collation(collationDocument)',
                        },
                        comment: {
                            link: 'https://docs.mongodb.com/manual/reference/method/cursor.comment',
                            description: 'Adds a comment field to the query.',
                            example: "db.collection.find(query, projection, options).comment('Comment')",
                        },
                        count: {
                        ...
                        explain: {
                            ...
                            example: 'db.collection.find(query, projection, options).explain()',
                        },
                        forEach: {
                            link: 'https://docs.mongodb.com/manual/reference/method/cursor.forEach',
                            description: 'Iterates the cursor to apply a JavaScript function to each document from the cursor.',
                            example: 'db.collection.find(query, projection, options).forEach(function)',
                        },
                        getQueryPlan: {
                            link: 'https://docs.mongodb.com/manual/reference/method/cursor.explain',
                            description: 'Runs cursor.explain()',
                            example: 'db.collection.find(query, projection, options).getQueryPlan()',
                        },
                        hasNext: {
                            link: 'https://docs.mongodb.com/manual/reference/method/cursor.hasNext',
                            ...
                            example: 'db.collection.find(query, projection, options).hasNext()',
                        },
                        hint: {
                            ...
                            example: 'db.collection.find(query, projection, options).hint(index)',
                        },
                        isClosed: {
                            link: 'https://docs.mongodb.com/manual/reference/method/cursor.isClosed',
                            description: 'Returns true if the cursor is closed.',
                            example: 'db.collection.find(query, projection, options).isClosed()',
                        },
                        isExhausted: {
                            link: 'https://docs.mongodb.com/manual/reference/method/cursor.isExhausted',
                            description: 'cursor.isExhausted() returns true if the cursor is closed and there are no remaining objects in the batch.',
                            example: 'db.collection.find(query, projection, options).isExhausted()',
                        },
                        itcount: {
                            link: 'https://docs.mongodb.com/manual/reference/method/cursor.itcount',
                            description: 'Counts the number of documents remaining in a cursor. itcount() is similar to cursor.count(), but actually executes the query on an existing iterator, exhausting its contents in the process.',
                            example: 'db.collection.find(query, projection, options).itcount()',
                        },
                        length: {
                            link: 'https://docs.mongodb.com/manual/reference/method/cursor.count',
                            description: 'Runs cursor.count()',
                            example: 'db.collection.find(query, projection, options).length()',
                        },
                        limit: {
                            ...
                            example: 'db.collection.find(query, projection, options).limit(2)',
                        },
                        map: {
                            link: 'https://docs.mongodb.com/manual/reference/method/cursor.map',
                            description: 'Applies the first argument, a function, to each document visited by the cursor and collects the return values from successive application into an array.',
                            example: 'db.collection.find(query, projection, options).map(function)',
                        },
                        max: {
                            ...
                            example: 'db.collection.find(query, projection, options).max(indexBoundsDocument)',
                        },
                        maxScan: {
                        ...
                        maxTimeMS: {
                            link: 'https://docs.mongodb.com/manual/reference/method/cursor.maxTimeMS',
                            description: 'Specifies a cumulative time limit in milliseconds for processing operations on a cursor.',
                            example: 'db.collection.find(query, projection, options).maxTimeMS(timeLimit)',
                        },
                        maxAwaitTimeMS: {
                            ...
                            example: 'db.collection.find(query, projection, options).maxAwaitTimeMS(timeLimit)',
                        },
                        min: {
                            ...
                            example: 'db.collection.find(query, projection, options).min(indexBoundsDocument)',
                        },
                        modifiers: {
                            link: '',
                            description: 'Get query modifiers.',
                            example: 'db.collection.find(query, projection, options).modifiers()',
                        },
                        next: {
                            link: 'https://docs.mongodb.com/manual/reference/method/cursor.next',
                        ...
                        noCursorTimeout: {
                            ...
                            example: 'db.collection.find(query, projection, options).noCursorTimeout()',
                        },
                        objsLeftInBatch: {
                            link: 'https://docs.mongodb.com/manual/reference/method/cursor.objsLeftInBatch',
                            description: 'cursor.objsLeftInBatch() returns the number of documents remaining in the current batch.',
                            example: 'db.collection.find(query, projection, options).objsLeftInBatch()',
                        },
                        oplogReplay: {
                            link: '',
                            description: 'Sets oplogReplay cursor flag to true.',
                            example: 'db.collection.find(query, projection, options).oplogReplay()',
                        },
                        projection: {
                            link: '',
                            description: 'Sets a field projection for the query.',
                            example: 'db.collection.find(query, projection, options).projection(field)',
                        },
                        pretty: {
                            description: 'Deprecated. The shell provides auto-formatting so this method is no longer useful',
                        },
                        readConcern: {
                            ...
                            example: 'db.collection.find(query, projection, options).readConcern(level)',
                        },
                        readonly: {
                            link: '',
                            description: '',
                        ...
                        readPref: {
                            ...
                            example: 'db.collection.find(query, projection, options).readPref(mode, tagSet)',
                        },
                        returnKey: {
                            ...
                            example: 'db.collection.find(query, projection, options).returnKey()',
                        },
                        showDiskLoc: {
                            link: '',
                            ...
                            example: 'db.collection.find(query, projection, options).showDiskLoc()',
                        },
                        showRecordId: {
                            ...
                            example: 'db.collection.find(query, projection, options).showRecordId',
                        },
                        size: {
                        ...
                        skip: {
                            link: 'https://docs.mongodb.com/manual/reference/method/cursor.skip',
                            description: 'Call the cursor.skip() method on a cursor to control where MongoDB begins returning results. This approach may be useful in implementing paginated results.',
                            example: 'db.collection.find(query, projection, options).skip(offsetNumber)',
                        },
                        snapshot: {
                            link: '',
                            ...
                            example: 'db.collection.find(query, projection, options).snapshot()',
                        },
                        sort: {
                            link: 'https://docs.mongodb.com/manual/reference/method/cursor.sort',
                            description: 'Specifies the order in which the query returns matching documents. You must apply sort() to the cursor before retrieving any documents from the database.',
                            example: 'db.collection.find(query, projection, options).sort(sortDocument)',
                        },
                        tailable: {
                            link: 'https://docs.mongodb.com/manual/reference/method/cursor.tailable',
                            description: 'Marks the cursor as tailable.',
                            example: 'db.collection.find(query, projection, options).tailable({ awaitData: true })',
                        },
                        toArray: {
                            link: 'https://docs.mongodb.com/manual/reference/method/cursor.toArray',
                            description: 'The toArray() method returns an array that contains all the documents from a cursor. The method iterates completely the cursor, loading all the documents into RAM and exhausting the cursor.',
                            example: 'db.collection.find(query, projection, options).toArray()',
                        },
                    },
                },
            },
                ...
                help: {
                    ...
                    attributes: {
                        ...
                        moveRange: {
                            ...
                            description: 'Moves a range of documents specified by the min and max keys to the destination shard. Uses the moveRange command',
                        ...
                        shardAndDistributeCollection: {
                            description: 'Shards a collection and then immediately reshards the collection to the same shard key.',
                            example: 'sh.shardAndDistributeCollection(ns, key, unique?, options?)',
                        },
                        moveCollection: {
                            link: 'https://docs.mongodb.com/manual/reference/method/sh.moveCollection',
                            description: 'Moves a single unsharded collection to a different shard.',
                            example: 'sh.moveCollection(ns, toShard)',
                        },
                        abortMoveCollection: {
                            link: 'https://docs.mongodb.com/manual/reference/method/sh.abortMoveCollection',
                            description: 'Abort the current moveCollection operation on a given collection',
                            example: 'sh.abortMoveCollection(ns)',
                        },
                        unshardCollection: {
                            link: 'https://docs.mongodb.com/manual/reference/method/sh.unshardCollection',
                            description: 'Unshard the given collection and move all data to the given shard.',
                        ...
                        abortUnshardCollection: {
                            ...
                            description: 'Abort the current unshardCollection operation on a given collection',
                            example: 'sh.abortUnshardCollection(ns)',
                        },
                        listShards: {
                            link: 'https://docs.mongodb.com/manual/reference/method/sh.listShards',
                            description: 'Returns a list of the configured shards in a sharded cluster',
                            example: 'sh.listShards()',
                        },
                        isConfigShardEnabled: {
                            link: 'https://docs.mongodb.com/manual/reference/method/sh.isConfigShardEnabled',
                            description: 'Returns a document with an `enabled: <boolean>` field indicating whether the cluster is configured as embedded config server cluster. If it is, then the config shard host and tags are also returned.',
                ...
                help: {
                    ...
                    attributes: {
                        ...
                        bulkWrite: {
                            ...
                            description: 'Performs multiple write operations across databases and collections with controls for order of execution.',
            ...
            Streams: {
                help: {
                    ...
                    attributes: {
                        process: {
                            description: 'Allows a user to process streams of data in the shell interactively and quickly iterate building a stream processor as they go.',
                        },
                        ...
                        listConnections: {
                            description: 'Show a list of all the named connections for this instance from the Connection Registry.',
                        },
                    },
                },
            },
            StreamProcessor: {
                help: {
                    ...
                    attributes: {
                        ...
                        sample: {
                            description: 'Return a sample of the results from a named stream processor.',
                        },
                        stats: {
                            description: 'Return stats captured from a named stream processor.',
                        },
                        modify: {
