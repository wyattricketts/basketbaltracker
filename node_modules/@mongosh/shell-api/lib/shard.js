...
let Shard = (() => {
    ...
    let _shardAndDistributeCollection_decorators;
    let _moveCollection_decorators;
    let _abortMoveCollection_decorators;
    let _unshardCollection_decorators;
    let _abortUnshardCollection_decorators;
    let _listShards_decorators;
    let _isConfigShardEnabled_decorators;
    var Shard = _classThis = class extends _classSuper {
        ...
        async moveRange(ns, toShard, min, max) {
            (0, helpers_1.assertArgsDefinedType)([ns, toShard, min, max], ['string', 'string', ['object', undefined], ['object', undefined]], 'Shard.moveRange');
        ...
        async shardAndDistributeCollection(ns, key, unique, options) {
            ...
            const reshardOptions = {
                forceRedistribution: true,
            };
            if ((options === null || options === void 0 ? void 0 : options.numInitialChunks) !== undefined) {
                reshardOptions.numInitialChunks = options.numInitialChunks;
            }
            if ((options === null || options === void 0 ? void 0 : options.collation) !== undefined) {
                reshardOptions.collation = options.collation;
            }
            return await this.reshardCollection(ns, key, reshardOptions);
        }
        async moveCollection(ns, toShard) {
            (0, helpers_1.assertArgsDefinedType)([ns, toShard], ['string', 'string'], 'Shard.moveCollection');
        ...
        async abortMoveCollection(ns) {
            (0, helpers_1.assertArgsDefinedType)([ns], ['string'], 'Shard.abortMoveCollection');
        ...
        async unshardCollection(ns, toShard) {
            (0, helpers_1.assertArgsDefinedType)([ns, toShard], ['string', 'string'], 'Shard.unshardCollection');
        ...
        async abortUnshardCollection(ns) {
            (0, helpers_1.assertArgsDefinedType)([ns], ['string'], 'Shard.abortUnshardCollection');
        ...
        async listShards() {
            ...
            await (0, helpers_1.getConfigDB)(this._database);
            return (_a = (await this._database.adminCommand({ listShards: 1 })).shards) !== null && _a !== void 0 ? _a : [];
        }
        async isConfigShardEnabled() {
            this._emitShardApiCall('isConfigShardEnabled', {});
            await (0, helpers_1.getConfigDB)(this._database);
            const shards = (await this._database.adminCommand({ listShards: 1 }))
                .shards;
            const configShard = shards === null || shards === void 0 ? void 0 : shards.find((s) => s._id === 'config');
            if (!configShard) {
    ...
    (() => {
        ...
        _moveRange_decorators = [decorators_1.returnsPromise, (0, decorators_1.serverVersions)(['6.0.0', enums_1.ServerVersions.latest])];
        ...
        _shardAndDistributeCollection_decorators = [decorators_1.returnsPromise, (0, decorators_1.serverVersions)(['5.0.0', enums_1.ServerVersions.latest])];
        _moveCollection_decorators = [(0, decorators_1.serverVersions)(['8.0.0', enums_1.ServerVersions.latest]), (0, decorators_1.apiVersions)([]), decorators_1.returnsPromise];
        _abortMoveCollection_decorators = [(0, decorators_1.serverVersions)(['8.0.0', enums_1.ServerVersions.latest]), (0, decorators_1.apiVersions)([]), decorators_1.returnsPromise];
        _unshardCollection_decorators = [(0, decorators_1.serverVersions)(['8.0.0', enums_1.ServerVersions.latest]), (0, decorators_1.apiVersions)([]), decorators_1.returnsPromise];
        _abortUnshardCollection_decorators = [(0, decorators_1.serverVersions)(['8.0.0', enums_1.ServerVersions.latest]), (0, decorators_1.apiVersions)([]), decorators_1.returnsPromise];
        _listShards_decorators = [(0, decorators_1.apiVersions)([]), decorators_1.returnsPromise];
        _isConfigShardEnabled_decorators = [(0, decorators_1.serverVersions)(['8.0.0', enums_1.ServerVersions.latest]), (0, decorators_1.apiVersions)([]), decorators_1.returnsPromise];
        ...
        __esDecorate(_classThis, null, _moveRange_decorators, { kind: "method", name: "moveRange", static: false, private: false, access: { has: obj => "moveRange" in obj, get: obj => obj.moveRange }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        __esDecorate(_classThis, null, _shardAndDistributeCollection_decorators, { kind: "method", name: "shardAndDistributeCollection", static: false, private: false, access: { has: obj => "shardAndDistributeCollection" in obj, get: obj => obj.shardAndDistributeCollection }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(_classThis, null, _moveCollection_decorators, { kind: "method", name: "moveCollection", static: false, private: false, access: { has: obj => "moveCollection" in obj, get: obj => obj.moveCollection }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(_classThis, null, _abortMoveCollection_decorators, { kind: "method", name: "abortMoveCollection", static: false, private: false, access: { has: obj => "abortMoveCollection" in obj, get: obj => obj.abortMoveCollection }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(_classThis, null, _unshardCollection_decorators, { kind: "method", name: "unshardCollection", static: false, private: false, access: { has: obj => "unshardCollection" in obj, get: obj => obj.unshardCollection }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(_classThis, null, _abortUnshardCollection_decorators, { kind: "method", name: "abortUnshardCollection", static: false, private: false, access: { has: obj => "abortUnshardCollection" in obj, get: obj => obj.abortUnshardCollection }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(_classThis, null, _listShards_decorators, { kind: "method", name: "listShards", static: false, private: false, access: { has: obj => "listShards" in obj, get: obj => obj.listShards }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(_classThis, null, _isConfigShardEnabled_decorators, { kind: "method", name: "isConfigShardEnabled", static: false, private: false, access: { has: obj => "isConfigShardEnabled" in obj, get: obj => obj.isConfigShardEnabled }, metadata: _metadata }, null, _instanceExtraInitializers);
