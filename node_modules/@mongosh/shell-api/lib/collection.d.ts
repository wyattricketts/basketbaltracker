...
import type { FindAndModifyShellOptions, FindAndModifyMethodShellOptions, RemoveShellOptions, MapReduceShellOptions, SearchIndexDefinition } from './helpers';
import type { AnyBulkWriteOperation, BulkWriteOptions, CountOptions, CountDocumentsOptions, ChangeStreamOptions, CreateIndexesOptions, DeleteOptions, DistinctOptions, Document, EstimatedDocumentCountOptions, ExplainVerbosityLike, FindOneAndDeleteOptions, FindOneAndReplaceOptions, FindOneAndUpdateOptions, FindOptions, InsertOneOptions, ReplaceOptions, RunCommandOptions, UpdateOptions, DropCollectionOptions, CheckMetadataConsistencyOptions, AggregateOptions, SearchIndexDescription } from '@mongosh/service-provider-core';
import type { RunCommandCursor, Database } from './index';
import { AggregationCursor, BulkWriteResult, CommandResult, Cursor, DeleteResult, Explainable, InsertManyResult, InsertOneResult, UpdateResult } from './index';
...
export default class Collection extends ShellApiWithMongoClass {
    ...
    aggregate(pipeline: Document[], options?: AggregateOptions): Promise<AggregationCursor>;
    ...
    stats(originalOptions?: Document | number): Promise<Document>;
    ...
    _getShardedCollectionInfo(config: Database, collStats: Document[]): Promise<Document>;
    ...
    createSearchIndex(name: string, definition: SearchIndexDefinition): Promise<string>;
    createSearchIndex(name: string, type: 'search' | 'vectorSearch', definition: SearchIndexDefinition): Promise<string>;
    createSearchIndex(definition: SearchIndexDefinition, type?: 'search' | 'vectorSearch'): Promise<string>;
