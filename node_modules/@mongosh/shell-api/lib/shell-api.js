...
const mongosh_version_1 = require("./mongosh-version");
...
let ShellApi = (() => {
    ...
    var ShellApi = _classThis = class extends _classSuper {
        ...
        version() {
            return mongosh_version_1.MONGOSH_VERSION;
        }
        async load(filename) {
    ...
    (() => {
        ...
        __untrackedShow_decorators = [decorators_1.returnsPromise];
