...
class ShellInstanceState {
    ...
    async fetchConnectionInfo() {
        ...
        if (!this.cliOptions.nodb) {
            ...
            this.messageBus.emit('mongosh:connect', {
                ...connectionInfo === null || connectionInfo === void 0 ? void 0 : connectionInfo.extraInfo,
                resolved_hostname: connectionInfo === null || connectionInfo === void 0 ? void 0 : connectionInfo.resolvedHostname,
                ...
                uri: (0, mongodb_redact_1.default)((_a = connectionInfo === null || connectionInfo === void 0 ? void 0 : connectionInfo.extraInfo) === null || _a === void 0 ? void 0 : _a.uri),
            });
    ...
    get currentServiceProvider() {
        var _a;
        try {
            return ((_a = this.currentDb._mongo._serviceProvider) !== null && _a !== void 0 ? _a : this.initialServiceProvider);
        }
        catch (err) {
    ...
    getAutocompleteParameters() {
        return {
            topology: () => {
                ...
                switch (topologyType) {
                    ...
                    default:
                        ...
                        if ((topologyDescription === null || topologyDescription === void 0 ? void 0 : topologyDescription.servers.size) === 1) {
                            const [server] = topologyDescription === null || topologyDescription === void 0 ? void 0 : topologyDescription.servers.values();
                            switch (server.type) {
                                case 'Mongos':
                                    topology = enums_1.Topologies.Sharded;
                                    break;
            ...
            connectionInfo: () => {
                var _a, _b;
                return (_b = (_a = this.cachedConnectionInfo()) === null || _a === void 0 ? void 0 : _a.extraInfo) !== null && _b !== void 0 ? _b : undefined;
            },
    ...
    apiVersionInfo() {
        ...
        return (serverApi === null || serverApi === void 0 ? void 0 : serverApi.version)
    ...
    async getDefaultPrompt() {
        ...
        if ((_a = connectionInfo === null || connectionInfo === void 0 ? void 0 : connectionInfo.extraInfo) === null || _a === void 0 ? void 0 : _a.is_stream) {
    ...
    async getDefaultPromptPrefix() {
        var _a, _b;
        const connectionInfo = await this.fetchConnectionInfo();
        const extraConnectionInfo = connectionInfo === null || connectionInfo === void 0 ? void 0 : connectionInfo.extraInfo;
        ...
        else if (extraConnectionInfo === null || extraConnectionInfo === void 0 ? void 0 : extraConnectionInfo.is_local_atlas) {
            return 'AtlasLocalDev';
        }
        else if (extraConnectionInfo === null || extraConnectionInfo === void 0 ? void 0 : extraConnectionInfo.is_atlas) {
            return 'Atlas';
        }
        else if ((extraConnectionInfo === null || extraConnectionInfo === void 0 ? void 0 : extraConnectionInfo.is_enterprise) ||
            ((_b = (_a = connectionInfo === null || connectionInfo === void 0 ? void 0 : connectionInfo.buildInfo) === null || _a === void 0 ? void 0 : _a.modules) === null || _b === void 0 ? void 0 : _b.indexOf('enterprise')) >= 0) {
            return 'Enterprise';
        }
        return '';
    }
    async getTopologySpecificPrompt() {
        ...
        switch (description.type) {
            case 'Single':
                ...
                serverTypePrompt = (singleDetails === null || singleDetails === void 0 ? void 0 : singleDetails.serverType)
            ...
            case 'ReplicaSetWithPrimary':
                ...
                break;
            case 'Sharded':
                serverTypePrompt = ((_c = connectionInfo === null || connectionInfo === void 0 ? void 0 : connectionInfo.extraInfo) === null || _c === void 0 ? void 0 : _c.atlas_version)
                    ? ''
                    : '[mongos]';
                break;
            case 'LoadBalanced':
