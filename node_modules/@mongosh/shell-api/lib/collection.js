...
let Collection = (() => {
    ...
    var Collection = _classThis = class extends _classSuper {
        ...
        async findAndModify(options) {
            ...
            if (reducedOptions.projection !== undefined &&
                ...
                throw new errors_1.MongoshInvalidInputError('Cannot specify both .fields and .projection for findAndModify()', errors_1.CommonErrors.InvalidArgument);
            }
            (_a = reducedOptions.projection) !== null && _a !== void 0 ? _a : (reducedOptions.projection = reducedOptions.fields);
            delete reducedOptions.query;
            delete reducedOptions.update;
            delete reducedOptions.fields;
            if (options.remove) {
        ...
        async _getAggregatedCollStats(scale) {
            try {
                ...
                if ((e === null || e === void 0 ? void 0 : e.codeName) === 'StaleConfig' ||
                    (e === null || e === void 0 ? void 0 : e.code) === 13388 ||
                    (e === null || e === void 0 ? void 0 : e.codeName) === 'FailedToParse') {
                    try {
        ...
        async _getShardedCollectionInfo(config, collStats) {
            const ns = `${this._database._name}.${this._name}`;
            ...
            const timeseriesShardStats = collStats.find((extractedShardStats) => typeof extractedShardStats.storageStats.timeseries !== 'undefined');
            ...
            const timeseries = storageStats.timeseries;
            const timeseriesBucketNs = timeseries.bucketsNs;
            ...
            if (!timeseriesCollectionInfo) {
                throw new errors_1.MongoshRuntimeError(`Error finding collection information for ${timeseriesBucketNs}`, errors_1.CommonErrors.CommandFailed);
            }
        ...
        async getShardDistribution() {
            ...
            await Promise.all(collStats.map((extractedShardStats) => (async () => {
                ...
                const orphanDocumentsSize = ((_a = extractedShardStats.storageStats.numOrphanDocs) !== null && _a !== void 0 ? _a : 0) *
                    ((_b = extractedShardStats.storageStats.avgObjSize) !== null && _b !== void 0 ? _b : 0);
                ...
                const shardStatsCount = (_c = shardStats.count) !== null && _c !== void 0 ? _c : NaN;
                const estimatedChunkDataPerChunk = shardStats.numChunks === 0
                    ? 0
                    : shardStats.size / shardStats.numChunks;
                const estimatedDocsPerChunk = shardStats.numChunks === 0
                    ? 0
                ...
                result[`Shard ${shardStats.shardId} at ${shardStats.host}`] = {
                    ...
                    'estimated data per chunk': (0, helpers_1.dataFormat)(estimatedChunkDataPerChunk),
                    'estimated docs per chunk': estimatedDocsPerChunk,
                };
                totals.size += (0, helpers_1.coerceToJSNumber)(ownedSize);
                totals.count += (0, helpers_1.coerceToJSNumber)(shardStatsCount);
        ...
        async createSearchIndex(nameOrOptions, typeOrOptions, definition) {
            let indexDescription;
            if (typeof nameOrOptions === 'object' &&
                nameOrOptions !== null &&
                nameOrOptions.definition) {
                indexDescription = nameOrOptions;
            }
            else {
                let indexName;
                let indexType;
                ...
                indexDescription = {
                    name: indexName !== null && indexName !== void 0 ? indexName : 'default',
                    ...(indexType &&
                        indexType !== 'search' && {
                        type: indexType,
                    }),
            ...
            const results = await this._mongo._serviceProvider.createSearchIndexes(this._database._name, this._name, [indexDescription]);
            return results[0];
        }
    ...
    (() => {
        ...
        _renameCollection_decorators = [decorators_1.returnsPromise, (0, decorators_1.apiVersions)([1])];
