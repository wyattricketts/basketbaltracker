...
const ShotStats = ({ shotData }) => {
  const calculateStats = () => {
    ...
    return { totalShots, madeShots, percentageMade, pointsPerShot };
  };

  const { totalShots, madeShots, percentageMade, pointsPerShot } = calculateStats();

  return (
    <div>
      <h2>Shot Statistics</h2>
      <p>Total Shots: {totalShots}</p>
      <p>Made Shots: {madeShots}</p>
